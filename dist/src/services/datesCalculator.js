...
class DatesCalculator {
    constructor() {
        ...
        this.calculateDates = (date, region = 'england-and-wales') => __awaiter(this, void 0, void 0, function* () {
            ...
            const bankHolidaysRes = yield this.getBankHolidays(nextMonday.format('YYYY-MM-DD'), region);
        ...
        this.getBankHolidays = (date, division) => __awaiter(this, void 0, void 0, function* () {
            ...
            const dateString = givenDate.format('YYYY-MM-DD');
            return {
                success: true,
                message: `Found ${holidays.length} holidays in the working week commencing ${dateString}`,
                data: holidays
            };
        });
    }
